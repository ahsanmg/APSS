...
A light-weight Vehicle Surveillance System by [Ahsan Ullah](https://github.com/ahsanmg) and [Muhammad Zohaib Shahid](https://github.com/muhammadzohaibshahid) for BS Computer Science Final Year Project, at [Khushal Khan Khattak University, Karak, PK](https://kkkuk.edu.pk). This project is part obsession, part survival, and a fair amount of spaghetti code.
